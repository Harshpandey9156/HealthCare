...
interface ThemeContextValue {
  ...
  gradients:  GradientPalette;         // ← use shared interface, not literal tuple type
...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  const colors:    typeof DARK_COLORS = isDark ? DARK_COLORS : LIGHT_COLORS;
  const gradients: GradientPalette    = isDark ? DARK_GRADIENTS : LIGHT_GRADIENTS;
